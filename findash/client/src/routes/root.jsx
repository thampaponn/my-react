                        ...
                        <div className='flex bg-white w-1/2 mx-4 rounded-xl items-center overflow-hidden'>
                            <div className='flex flex-col w-1/2 ml-8'>
                                ...
                                <div className='flex h-full items-center my-4'>
                                    <button className='flex justify-center text-s w-full text-white bg-[#4C49ED] border-2 border-[#4C49ED] rounded-full py-3 mr-1 hover:bg-[#312eea] hover:border-[#312eea] hover:text-gray-200 transition-colors duration-300'>TOP UP</button>
                            ...
                            <div className='flex flex-col justify-center items-center bg-[#4C49ED] w-1/2 h-full rounded-l-full ml-16'>
                                <div className='flex items-end'>
                                    <p className='flex text-2xl text-white'>{pb.authStore.model.money} บาท</p>
                                </div>
